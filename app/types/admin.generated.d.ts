...
export type ShopifyReactRouterTemplateUpdateVariantMutationVariables =
  AdminTypes.Exact<{
...
export type ShopifyReactRouterTemplateUpdateVariantMutation = {
...
interface GeneratedMutationTypes {
  ...
  "#graphql\n    mutation shopifyReactRouterTemplateUpdateVariant($productId: ID!, $variants: [ProductVariantsBulkInput!]!) {\n      productVariantsBulkUpdate(productId: $productId, variants: $variants) {\n        productVariants {\n          id\n          price\n          barcode\n          createdAt\n        }\n      }\n    }": {
    return: ShopifyReactRouterTemplateUpdateVariantMutation;
    variables: ShopifyReactRouterTemplateUpdateVariantMutationVariables;
  };
}
